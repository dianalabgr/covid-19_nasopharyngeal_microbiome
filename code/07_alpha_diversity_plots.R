...
figure01 = ggarrange(p1,p2,
                     labels=c("A","B"),
                     ncol=1, nrow=2)
ggsave(paste0(figures_dir, "/Figure1.pdf"), height=8, width=5, device="pdf") # save a PDF 3 inches by 4 inches
ggsave(paste0(figures_dir, "/Figure1.png"), height=8, width=5, device="png") # save a PNG 3 inches by 4 inches
